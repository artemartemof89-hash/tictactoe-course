# Курсовой проект "Крестики-Нолики"
...
Курсовой проект выполняется студентом самостоятельно или в паре.
...
3. **Защита реализации**. Необходимо защитить преподавателю вашу реализацию,
   показав, что игрок (или игроки) играет корректно по вашему алгоритму.

4. **Написание отчёта**. В отчете необходимо привести описание алгоритма, 
...
**В случае совместной работы** добавляются ещё два пункта:

5. **Игра вдвоём**. Следует добавить в CMake-проект цель для запуска игры одного из написанных игроков против другого (аналогично `test_my_player`).
...
6. **CI**. Следует добавить CI с использованием GitHub Actions для сборки целей и запуска тестов.
